...
public class SearchFilesDialog extends ListActivity implements TextWatcher {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txtSearch.addTextChangedListener(SearchFilesDialog.this);
    ...
    private void showMessage(String message) {
        Toast.makeText(SearchFilesDialog.this, message, Toast.LENGTH_SHORT).show();
    }

    private Animation launchAnimation(int id) {

        return AnimationUtils.loadAnimation(SearchFilesDialog.this, id);
    }
    ...
    public void getOperations(final String filepath) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SearchFilesDialog.this);
            ...
            public void onClick(DialogInterface dInterface, int item) {
                ...
                switch (item) {
                    ...
                    case 0:
                        ...
                        final AlertDialog alertDialog1 = new AlertDialog.Builder(SearchFilesDialog.this).create();
                    ...
                    case 1:
                        ...
                        if (file.isDirectory()) {
                            Toast.makeText(SearchFilesDialog.this, "can't send a folder...create a zip file !", Toast.LENGTH_SHORT).show();
                    ...
                    case 3:
                        ...
                        if (!query.moveToFirst()) {
                            ...
                            Toast.makeText(SearchFilesDialog.this, "Bookmark Added", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(SearchFilesDialog.this, "Bookmark Exists ", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void getProperties(File file) {
        ...
        final Dialog dialog1 = new Dialog(SearchFilesDialog.this);
        ...
        String total_size = FileUtils.formatSize(SearchFilesDialog.this, file.length());
        ...
        if (Build.VERSION.SDK_INT >= 8) {
            sdcard_free.setText(" " + String.valueOf(FileUtils.formatSize(SearchFilesDialog.this, file.getFreeSpace())));
            sdcard_total.setText(" " + String.valueOf(FileUtils.formatSize(SearchFilesDialog.this, file.getTotalSpace())));

        } else {
            sdcard_free.setText(" " + String.valueOf(FileUtils.formatSize(SearchFilesDialog.this, stat.getAvailableBlocks() * stat.getBlockSize())));
            sdcard_total.setText(" " + String.valueOf(FileUtils.formatSize(SearchFilesDialog.this, stat.getBlockCount() * stat.getBlockSize())));
    ...
    public void OnclickOperation(final String filepath) {
        ...
        if (ext.equalsIgnoreCase(".pdf")) {
            ...
            try {
                ...
                final Intent intent = new Intent(SearchFilesDialog.this, PDFViewer.class);
    ...
    class FoundList extends ArrayAdapter<String> {
        ...
        public FoundList() {
            super(SearchFilesDialog.this, R.layout.searchrow, founditems);
            imageLoader = new ImageThreadLoader(SearchFilesDialog.this);
            drawableLoader = new DrawableThreadLoader(SearchFilesDialog.this);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (f.isFile() && ext.equalsIgnoreCase(".apk")) { //decide are the file folder or file
                ...
                imageLoader.displayImage(filepath, SearchFilesDialog.this, holder.image);
    ...
    Drawable getIcon(String filepath) {
        ...
        if (file.isDirectory()) {
            ...
            } else if (FileUtils.isExtImage(ext)) {
                return getResources().getDrawable(R.drawable.image);
            } else if (FileUtils.isExtAudio(ext)) {
                return getResources().getDrawable(R.drawable.audio);
            } else if (ext.equalsIgnoreCase(".apk")) {
                return new FileUtils(SearchFilesDialog.this).getapkicon(filepath);
            } else if (FileUtils.isExtVideo(ext)) {
